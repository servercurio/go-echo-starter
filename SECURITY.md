...
If you cannot use GitHub's reporting flow, email the maintainer at **nathan.klick@servercurio.com** with the subject line `[SECURITY] go-echo-starter`. Encrypted mail is welcome; ask for a current public key in your initial (unencrypted) message.
